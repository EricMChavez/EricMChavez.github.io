...
const Footer = () =>{
    return(
        <div className="full" id="footer">
            ...
            <div id="tagline">Designed, Developed, and Maintained by Eric Chavez</div>
            <div id="flaticon">Icons made by <a href="https://www.flaticon.com/authors/freepik" title="Freepik">Freepik
